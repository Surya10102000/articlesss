const links = {
    twitter : "https://x.com/MallahSurya",
    github : "https://github.com/Surya10102000",
    linkedin : "https://www.linkedin.com/in/surya-prakash-mallah/",
    google : "mailto:Suryaprakashmallah@gmail.com"
}
  ...
  return (
    ...
    <footer
      ...
      <div className="w-full bg-black/5 p-4 text-center">
        © 2023 Copyright:
        <a className="font-semibold" href=""> Surya</a>
      </div>
    </footer></div>
  )
}
