    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-zinc-900 dark:bg-zinc-100">
      <div className="container px-4 md:px-6 flex flex-col items-center text-center">
        ...
        <div className="flex justify-center space-x-4">
          <Link to="#" aria-label="Facebook page" className="text-white">
            <FacebookIcon className="h-6 w-6" />
          </Link>
          <Link to="#" aria-label="Twitter profile" className="text-white">
            <TwitterIcon className="h-6 w-6" />
          </Link>
          <Link to="#" aria-label="Instagram profile" className="text-white">
            <InstagramIcon className="h-6 w-6" />
          </Link>
          <Link to="#" aria-label="LinkedIn profile" className="text-white">
